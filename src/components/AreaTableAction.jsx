...
const AreaTableAction = ({darkMode}) => {
  ...
  return (
    <>
      <button
        type="button"
        className="action-dropdown-btn flex items-center justify-center gap-2"
      ...
      >
        ...
        <span className={`${darkMode && "text-blue-900"} text-[#0D062D] text-[14px]`}>View</span> 
        {showDropdown && (
